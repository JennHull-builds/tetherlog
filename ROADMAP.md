...
These files now live in this repo and are edited here. The copy-in workflow is retired.
...
**Files:** `@PRODUCT.md` `@ROADMAP.md` `@docs/LOOK.md` `@.cursorrules` `@src/views/CaptureView.tsx` `@src/views/ReviewView.tsx` `@src` (db / types as needed)
