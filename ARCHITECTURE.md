...
- Dexie over IndexedDB — local persistence, no server
...
| `src/components/LogStack.tsx` | Built, pulled from CaptureView in `aba3f5b`. Undecided |
...
Product intent and the full rule set: `PRODUCT.md`. Visual contract: `DESIGN.md`.
Current state and what gates the build: `docs/UI-OVERHAUL.md` and `docs/LOOK.md`.
